...
```text
src/
|- API/            # entrypoint HTTP, configuracoes, filtros, Swagger
|- Application/    # use cases, features, queries, handlers, models
|- Domain/         # entidades, value objects e contratos de dominio
|- Infrastructure/ # DbContext, mappings EF, repositorios, gateways, identity
|- Core/           # abstractions, utilitarios, recursos compartilhados
\- CrossCutting/   # servicos transversais e integracoes auxiliares
```
